...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-8 px-2 mt-8 ">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="https://www.linkedin.com/in/abhishek-agrawal-59b749274/" className="hover:text-gray-400" aria-label="LinkedIn">
          ...
          <div className="text-align: center; padding: 20px; background-color: #f4f4f4; font-size: 14px text-gray-600">
            Made by Abhishek <span className="color: red;">&#10084;</span>
            </div>
          </div>
